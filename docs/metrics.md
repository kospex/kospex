...
Here are some common questions people ask about their code and repositories:
- "what does good look like?"
- "is my code base healthy?"
- "is it secure?"
- "is it maintained?"

Here are some indicators that are easily measurable:
- Date of last commit
...
When looking at a dependency file, we can also provide more granular indications.
For example, for each dependency we can also identify:
- When was the last update (e.g. is it recent?)
...
While we may know if our repo is feature complete, still in active development, or scheduled for decommission, we won't really know the decisions an open source project has made.
